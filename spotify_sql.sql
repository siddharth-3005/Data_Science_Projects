...
-- 28. Find the top 5 tracks that have the highest acousticness percentage and the artist(s) who performed them.


-- 29. Calculate the total number of streams for tracks in each key, but weight the streams based on the artist's popularity (e.g., artist(s) with more tracks get a higher weight).

-- 30.Identify the top 10 tracks with the highest ratio of instrumentalness percentage to danceability percentage, and display both percentages along with the track name.